 ...
 * @since 0.1
 */
public class CachedExecuteBatchQueryClient implements TransportClient {

    private static final Logger LOG = LoggerFactory.getLogger(com.vk.api.sdk.httpclient.HttpTransportClient.class);
    ...
    public static com.vk.api.sdk.httpclient.HttpTransportClient getInstance() {
        if (instance == null) {
            instance = new com.vk.api.sdk.httpclient.HttpTransportClient();
        }
